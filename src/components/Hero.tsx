...
export default function Hero() {
  return (
    <div id="hero" className="relative min-h-screen flex overflow-hidden">
      ...
      <div className="md:w-1/2 flex flex-col justify-center p-8 md:pl-40 z-20">
        <p className="text-2xl font-bold mb-8">Hi, I am</p>
        <h1 className="text-4xl font-bold mb-2">Mohamad Sharafeddine</h1>
